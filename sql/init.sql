...
CREATE TABLE `_resource` (
  ...
  `operationAt` varchar(255) DEFAULT NULL COMMENT '操作时间; E.g: 2021-05-28T10:24:54+08:00 ',
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 337 COMMENT = '请求资源表; 软删除未启用; resourceId=`${appId}.${pageId}.${actionId}`';
...
INSERT INTO `_resource` (`id`,`accessControlTable`,`resourceHook`,`pageId`,`actionId`,`desc`,`resourceType`,`appDataSchema`,`resourceData`,`requestDemo`,`responseDemo`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`) VALUES (335,NULL,NULL,'pageLog','selectLogFileList','✅✅查询日志文件列表','service',NULL,'{ \"service\": \"pageLog\", \"serviceFunction\": \"selectLogFileList\" }','','','update',NULL,NULL,'2022-04-29T16:33:28+08:00');
INSERT INTO `_resource` (`id`,`accessControlTable`,`resourceHook`,`pageId`,`actionId`,`desc`,`resourceType`,`appDataSchema`,`resourceData`,`requestDemo`,`responseDemo`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`) VALUES (336,NULL,NULL,'pageLog','selectItemListFromLogFile','✅查询日志文件内容','service',NULL,'{ \"service\": \"pageLog\", \"serviceFunction\": \"selectItemListFromLogFile\" }','','','update',NULL,NULL,'2022-04-29T16:33:28+08:00');
...
INSERT INTO `student` (`id`,`studentId`,`name`,`gender`,`dateOfBirth`,`classId`,`level`,`bodyHeight`,`studentStatus`,`remarks`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`) VALUES (1,'W00001','小花','male','2020-02-03','2021-01级-01班','01','123','正常',NULL,'jhUpdate','admin','系统管理员','2023-04-28T08:37:07+08:00');
INSERT INTO `student` (`id`,`studentId`,`name`,`gender`,`dateOfBirth`,`classId`,`level`,`bodyHeight`,`studentStatus`,`remarks`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`) VALUES (2,'E00001','小绿','male','2020-02-02','2021-01级-02班','01','1233','正常',NULL,'jhUpdate','admin','系统管理员','2023-02-23T10:06:00+08:00');
